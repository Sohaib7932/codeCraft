...
export default function Projects() {
  ...
  return (
    <>
      ...
      <section className="section max-w-6xl mx-auto" style={{backgroundColor: 'var(--background-secondary)'}}>
        
        <div className="flex flex-col gap-10 mt-12">
          {projects.map((project) => (
            <div key={project.id} className="flex card rounded-2xl overflow-hidden transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-xl hover:shadow-gray-500/15 hover:border-gray-500 min-h-[300px]">
              <div className="flex-1 p-8 flex flex-col justify-between">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech, index) => (
                    <span key={index} className="bg-gray-800 text-gray-300 px-3 py-1.5 rounded-2xl text-sm font-medium border border-gray-600 transition-all duration-300 hover:bg-gray-600 hover:text-white hover:transform hover:-translate-y-0.5">{tech}</span>
                  ))}
                </div>
      ...
      <section className="section max-w-6xl mx-auto" style={{backgroundColor: 'var(--background-secondary)'}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-8">
          <div className="card rounded-lg p-5 flex items-center gap-4 transition-all duration-300 hover:border-gray-500 hover:transform hover:-translate-y-0.5">
      ...
      <section className="section max-w-6xl mx-auto" style={{backgroundColor: 'var(--background-secondary)'}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="card rounded-lg p-8 text-left transition-all duration-300 hover:border-gray-500 hover:transform hover:-translate-y-0.5">
